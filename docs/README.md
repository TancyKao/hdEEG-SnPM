...
|---|---|---|
| **Learn the tool** by doing a first run | **[Tutorials](tutorials/README.md)** | A guided lesson on synthetic data, end to end. |
...
- Synthetic fixtures → `test_data/synthetic_gui/README.md` (generated by `gen_synthetic_testdata`; not in the repository)
